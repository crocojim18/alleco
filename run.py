...
spiderList = ['aleppo_t', 'aspinwall_b', 'avalon_b', 'baldwin_b',
				...
				'moon_t', 'mount_lebanon_t', 'munhall_b', 'north_fayette_t', 'o_hara_t',
				'penn_hills_t', 'pennsbury_village_b', 'pittsburgh_c', 'pine_t', 'plum_b',
				'richland_t', 'robinson_t', 'ross_t', 'scott_t', 'shaler_t',
